...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("MITZUKY-BETA~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 MitZuky Beta is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© MitZuky Beta 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © MitZuky Beta 💚!** 🎉 
          ...
          --- Thank you for using **© MitZuky Beta 💚**. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94721931393@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "",
            newsletterName: "© MitZuky Beta 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© MitZuky Beta 💚",
            ...
            sourceUrl: "",
            thumbnailUrl:
              "https://i.ibb.co/nqyv38xB/20250824-170551.jpg", // This should match the image URL provided above
